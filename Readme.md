...
> **Важно:** При сравнении списков порядок элементов не учитывается. Сравнение происходит по принципу "мешка", где главное — наличие элементов, а не их позиция.
...
- сравнение дат
- настройка сравнения списков (учитывать порядок)
- возможно настройки сравнения как-то встроить в тесты, чтобы сделать персональными.
